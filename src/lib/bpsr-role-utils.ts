 ...
 */
export function parseBpsrRoleCustomId(
    customId: string
): ParsedBpsrRoleCustomId | null {
...
export function buildBpsrRoleComponents(
    ...
    const tankButton = new ButtonBuilder()
        .setCustomId(
            buildBpsrRoleCustomId("tank", tankRoleId, attackerRoleId, healerRoleId)
        )
    ...
    const attackerButton = new ButtonBuilder()
        .setCustomId(
            buildBpsrRoleCustomId("attacker", tankRoleId, attackerRoleId, healerRoleId)
        )
    ...
    const healerButton = new ButtonBuilder()
        .setCustomId(
            buildBpsrRoleCustomId("healer", tankRoleId, attackerRoleId, healerRoleId)
        )
