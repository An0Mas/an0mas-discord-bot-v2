...
## 目次
- [改善調査サマリ（2026-02-14）](./2026-02-14_summary.md)
- [リスク一覧（2026-02-14）](./2026-02-14_risks.md)
- [改善計画（10件・優先順）（2026-02-14）](./2026-02-14_plan-10.md)
- [付録（2026-02-14）](./2026-02-14_appendix.md)
- [改善対応トラッカー](./improvement-tracker.md)

## この監査の位置づけ
- 2026-02-06 監査の差分監査（行番号・実装状況の再評価）。
- ESLint/Prettier導入後のコード配置変化を前提に、根拠行を最新化。
- 旧監査のうち、解消済み項目と継続項目を再分類。
...
- 不明点は `未確認` と明記する。
- `improvement-tracker.md` では、各タスクに `参照（根拠ファイル）` を必ず記載する。
